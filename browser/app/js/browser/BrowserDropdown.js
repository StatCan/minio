          ...
          <Dropdown.Menu className="dropdown-menu-right">
            <li>
              <a href="" onClick={this.showChangePassword.bind(this)}>
                {t('changePassword')} <i className="fas fa-cog" />
              </a>
            ...
            <li>
              <a target="_blank" href="https://docs.min.io/?ref=ob">
                {t('documentation')} <i className="fas fa-book" />
              </a>
            </li>
            <li>
              <a target="_blank" href="https://github.com/minio/minio">
                {t('gitHub')} <i className="fab fa-github" />
              </a>
            </li>
            <li>
              <a target="_blank" href="https://min.io/pricing?ref=ob">
                {t('getSupport')} <i className="fas fa-question-circle" />
              </a>
            </li>
            <li>
              <a href="" id="show-about" onClick={this.showAbout.bind(this)}>
                {t('about')} <i className="fas fa-info-circle" />
              </a>
            ...
            <li>
              <a href="" id="logout" onClick={this.logout}>
                {t('common:logout')} <i className="fas fa-sign-out-alt" />
              </a>
            </li>
          </Dropdown.Menu>
        </Dropdown>
...
export default withTranslation('browserDropdown')(connect(mapStateToProps, mapDispatchToProps)(BrowserDropdown))
